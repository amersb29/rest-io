...
class CreateSedesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sedes = [
            ...
            [ 'id' => 3, 'countries_id' => 2, 'name' => 'Phoenix',          'calendar'=>'https://calendar.google.com/calendar/embed?showTitle=0&amp;showTabs=0&amp;showCalendars=0&amp;height=600&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=piedra.laura14%40gmail.com&amp;color=%2342104A&amp;ctz=America%2FDawson_Creek', 'code' => 'PHN' , 'created_at' => date('Y-m-d H:i:s'),],
            [ 'id' => 4, 'countries_id' => 2, 'name' => 'San Diego',        'calendar'=>'https://calendar.google.com/calendar/embed?src=9i3dgpobb3s68fc85fib031hes%40group.calendar.google.com&amp;ctz=America%2FMexico_City', 'code' => 'SD' , 'created_at' => date('Y-m-d H:i:s'),],
        ];
